...
exports.book_create_post = [
    ...
    body('isbn', 'ISBN must not empty').trim().isLength({ min: 1 }),
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                res.rend('book_form', { title: 'Create Book', authors: results.authors, genres: results.genres, book: book, errors: errors.array() })
            });
            return;
        } else {
...
exports.book_update_post = [
    ...
    (req, res, next) => {
        ...
        var book = new Book({
            ...
            summary: req.body.summary,
            isbn: req.body.isbn,
            genre: (typeof req.body.genre === 'undefinied') ? [] : req.body.genre,
        ...
        if (!errors.isEmpty()) {
            ...
            Book.findByIdAndUpdate(req.params.id, book, {}, function(err, thebook) {
                if (err) { return next(err) }
                //Sueccessful, redirect to book page.
